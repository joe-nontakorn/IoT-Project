...
#if defined(ESP32)
PZEM004Tv30 pzem(Serial2, 21, 19); //rx,tx
#else
...
//const char *mqtt_server = "de083670e24d4481a2e3efd00ddb3b07.s2.eu.hivemq.cloud";
...
const char *mqtt_clientId = "clientId-Bvx0rGqJdN";
...
void setupMQTT() {
  if (nb.connectMQTT(mqtt_server, mqtt_port, mqtt_clientId , mqtt_user, mqtt_password)) {
    ...
    //if (nb.connectMQTT(mqtt_server, mqtt_port, mqtt_user, mqtt_password)) {
    //nb.subscribe(topic_publish, subQoS);
  }
